...
image::opsiclientd-blocklogin-notifier.png["Abbildung: opsiclientd blocklogin notifier", pdfwidth=10%, scaledwidth=80]
...
image::opsiclientd-event-notifier.png["Abbildung: opsiclientd event notifier", pdfwidth=50%, scaledwidth=150]
...
image::opsiclientd-action-notifier.png["Abbildung: opsiclientd action notifier", pdfwidth=70%, scaledwidth=150]
...
image::opsiclientd-shutdown-notifier.png["Abbildung: opsiclientd shutdown notifier", pdfwidth=70%, scaledwidth=150]
...
image::eventflowchsrt.png["Abbildung: Ablauf eines Standard-Events", pdfwidth=90%, scaledwidth=400]
...
image::opsiclientd-configuration-via-configed-serverdefault.png["Abbildung: Serverweite Konfiguration des {opsiclientd} über den {opsi-configed}", pdfwidth=100%, scaledwidth=400]
...
image::opsiclientd-configuration-via-configed.png["Abbildung: Client spezifische Konfiguration des {opsiclientd} über den {opsi-configed}", pdfwidth=100%, scaledwidth=400]
...
image::opsiclientd_infopage_event_on_demand.png["Abbildung: Info-Page des {opsiclientd} nach einer Push-Installation mit aktiviertem Produkt-Caching", pdfwidth=80%, scaledwidth=400]
...
image::opsiclientd-control-server-web-interface.png["Abbildung: Webservice des {opsiclientd}", pdfwidth=80%]
...
image::opsi-systray-message.png["Abbildung: Message Fenster des opsi-systray Programms", pdfwidth=50%, scaledwidth=200]

.Kontext Menü (Rechte Maustaste) des opsi-systray Programms
image::opsi-systray-menue.png["Abbildung: Kontext Menü (Rechte Maustaste) des opsi-systray Programms", pdfwidth=50%, scaledwidth=200]
