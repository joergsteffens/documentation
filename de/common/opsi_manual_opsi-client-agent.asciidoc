...
image::opsiclientd-blocklogin-notifier.png["Abbildung: opsiclientd blocklogin notifier"]
...
image::opsiclientd-event-notifier.png["Abbildung: opsiclientd event notifier"]
...
image::opsiclientd-action-notifier.png["Abbildung: opsiclientd action notifier"]
...
image::opsiclientd-shutdown-notifier.png["Abbildung: opsiclientd shutdown notifier"]
...
image::opsiclientd-configuration-via-configed-serverdefault.png["Abbildung: Serverweite Konfiguration des {opsiclientd} über den {opsi-configed}"]
...
image::opsiclientd-configuration-via-configed.png["Abbildung: Client spezifische Konfiguration des {opsiclientd} über den {opsi-configed}"]
...
image::opsiclientd_infopage_event_on_demand.png["Abbildung: Info-Page des {opsiclientd} nach einer Push-Installation mit aktiviertem Produkt-Caching"]
...
image::opsi-systray-message.png["Abbildung: Message Fenster des opsi-systray Programms"]

.Kontext Menü (Rechte Maustaste) des opsi-systray Programms
image::opsi-systray-menue.png["Abbildung: Kontext Menü (Rechte Maustaste) des opsi-systray Programms"]
