...
image::netboot-pxe.png[pdfwidth=80%, scaledwidth=300]
...
image::netboot-pxelinux.png[pdfwidth=80%, scaledwidth=300]
...
image::netboot-pxeos.png[pdfwidth=80%, scaledwidth=300]
...
image::netboot-win-nt6-properties.png["NT6 Productproperties", pdfwidth=80%, scaledwidth=200]
...
.NT6 Imagenames
image::netboot-win-nt6-properties-imagenames.png["NT6 Imagenames", pdfwidth=60%, scaledwidth=200]
...
image::netboot-win-nt6-properties-keyboards.png["Sprachauswahl für die Tastatur", pdfwidth=60%, scaledwidth=200]
...
image::netboot-win-nt6-properties-winpartionsize.png["Größe der C: Partition", pdfwidth=60%, scaledwidth=200]
