...
** Das Bootimage fragt nach dem Hostnamen des Clients und der URL des opsi-server dienstes.

* Unabhängig von der gewählten Startoption erfolgt die Neuinstallation wie folgt:
