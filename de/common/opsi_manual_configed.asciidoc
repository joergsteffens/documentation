...
image::opsi-configed-login.png["Login des {opsi-configed}"]
...
image::configed_clientselection.png["{opsi-configed}: Auswahldialog"]
...
image::opsi-configed-client-new.png["{opsi-configed}: Client anlegen"]
...
image::opsi-configed-client-change-depot.png["{opsi-configed}: Client zu anderem Depot umziehen"]
...
image::opsi-configed-netbootproducts.png["{opsi-configed}: Tab Netboot-Produkte", scaledwidth=400]
...
image::opsi-configed-hardwareinformation.png["{opsi-configed}: Tab Hardware-Information", scaledwidth=400]
...
image::opsi-configed-hardwareinfo-treiberintegration.png["{opsi-configed}: Tab Hardware-Information - Treiberupload", scaledwidth=400]
...
image::opsi-configed-softwareinventory.png["{opsi-configed}: Tab Software-Inventur", scaledwidth=400]
...
image::opsi-configed-logfiles.png["{opsi-configed}: Tab Logdateien", scaledwidth=400]
...
image::opsi-configed-produkt-defaultproperties-jedit-verschiedene-werte.png["{opsi-configed}: Produkt-Defaultproperties: jEdit", scaledwidth=400]
...
image::opsi-configed-hostparameters.png["{opsi-configed}: Tab Hostparameter (als Serverkonfiguration)", scaledwidth=400]


.'{opsi-configed}': Tab Hostparameter (Kontextmenü eines Clienteintrags)
image::opsi-configed-hostparameter_setting.png["{opsi-configed}: Tab Hostparameter (Kontextmenü eines Clienteintrags)", scaledwidth=300]
...
image::opsi-configed-depotconfiguration.png["{opsi-configed}: Tab Depot-Konfiguration", scaledwidth=400]
...
image::configed_groupaction_localimage.png["{opsi-configed}: Gruppenaktionen (für opsi-local-image)", scaledwidth=400]
...
image::configed_package-actions.png["{opsi-configed}: Produktaktionen", scaledwidth=400]
...
image::configed_serverkonsole.png["{opsi-configed}: Server-Konsole", scaledwidth=400]
...
image::configed_serverkonsole-terminal.png["{opsi-configed}: SSH-Terminal", scaledwidth=400]
...
image::configed_serverkonsole-defcommands.png["{opsi-configed}: Befehle definieren", scaledwidth=400]
...
image::configed_serverkonsole-exec.png["{opsi-configed}: Befehl ausführen - Parameterabfrage", scaledwidth=400]
