...
image::opsi-configed-login.png["Login des {opsi-configed}", pdfwidth=50%]
...
image::opsi-configed-clientselection.png["{opsi-configed}: Client-Auswahl"]
...
image::opsi-configed-clientselection-search.png["{opsi-configed}: Client-Suche"]
...
image::opsi-configed-config-host-displayfields.png["{opsi-configed}: Spaltenkonfiguration für die Clientliste"]
...
image::configed_clientselection.png["{opsi-configed}: Auswahldialog", pdfwidth=80%]
...
image::opsi-configed-failedactions-today.png["{opsi-configed}: Fehlgeschlagene Aktionen - heute"]
...
image::opsi-configed-treeview.png["{opsi-configed}: Treeview"]
...
image::opsi-configed-treeview-generate-group.png["{opsi-configed}: Gruppe anlegen"]
...
image::opsi-configed-treeview-groupname.png["{opsi-configed}: Gruppenname und Beschreibung eingeben"]
...
image::opsi-configed-client-contextmenu.png["{opsi-configed}: Kontextmenü der Clientliste"]
...
image::opsi-configed-clientinfos.png["{opsi-configed}: Erweiterte Spaltensicht für opsi-Clients"]
...
image::opsi-configed-wake-on-lan-scheduler.png["{opsi-configed}: Schedule für Wake On Lan"]
...
image::opsi-configed-client-message-editing.png["{opsi-configed}: Bearbeitungsfenster einer Nachricht"]
...
image::opsi-configed-client-message-reading.png["{opsi-configed}: Nachrichtenfenster auf dem Client"]
...
image::opsi-configed-client-remotecontrol-choice.png["{opsi-configed}: Auswahl des Remote-Control-Aufrufs"]
...
image::opsi-configed-properties-remotecontrol.png["{opsi-configed}: Bearbeitung der Remote-Control-Aufrufe bei den Server-Konfigurationseinträgen"]
...
image::opsi-configed-client-new.png["{opsi-configed}: Client anlegen", pdfwidth=50%]
...
image::opsi-configed-localbootproducts.png["{opsi-configed}: Tab Produktkonfiguration"]
...
image::configed_productsearch.png["{opsi-configed}: Produktsuche, mit Kontextmenü"]
...
image::opsi-configed-editlist1.png["{opsi-configed}: Property-Tabelle", scale=40]
...
image::opsi-configed-editlist2.png["{opsi-configed}: Listen-Editor, Auswahlliste", scale=130]
...
image::opsi-configed-editlist3.png["{opsi-configed}: Listeneditor, Editierfeld", scale=130]
...
image::opsi-configed-netbootproducts.png["{opsi-configed}: Tab Netboot-Produkte", pdfwidth=90%, scaledwidth=400]
...
image::opsi-configed-hardwareinformation.png["{opsi-configed}: Tab Hardware-Information", pdfwidth=100%, scaledwidth=400]
...
image::opsi-configed-hardwareinfo-treiberintegration.png["{opsi-configed}: Tab Hardware-Information - Treiberupload", pdfwidth=100%, scaledwidth=400]
...
image::opsi-configed-softwareinventory.png["{opsi-configed}: Tab Software-Inventur", pdfwidth=80%, scaledwidth=400]
...
image::opsi-configed-logfiles.png["{opsi-configed}: Tab Logdateien", pdfwidth=80%, scaledwidth=400]
...
image::opsi-configed-produkt-defaultproperties-jedit-verschiedene-werte.png["{opsi-configed}: Produkt-Defaultproperties: jEdit", pdfwidth=90%, scaledwidth=400]
...
image::opsi-configed-hostparameters.png["{opsi-configed}: Tab Hostparameter (als Serverkonfiguration)", pdfwidth=80%, scaledwidth=400]


.'{opsi-configed}': Tab Hostparameter (Kontextmenü eines Clienteintrags)
image::opsi-configed-hostparameter_setting.png["{opsi-configed}: Tab Hostparameter (Kontextmenü eines Clienteintrags)", pdfwidth=70%, scaledwidth=300]
...
image::opsi-configed-depotconfiguration.png["{opsi-configed}: Tab Depot-Konfiguration", pdfwidth=90%, scaledwidth=400]
...
image::configed_groupaction_localimage.png["{opsi-configed}: Gruppenaktionen (für opsi-local-image)", pdfwidth=90%, scaledwidth=400]
...
image::configed_package-actions.png["{opsi-configed}: Produktaktionen", pdfwidth=70%, scaledwidth=400]
...
image::configed_serverkonsole.png["{opsi-configed}: Server-Konsole", pdfwidth=90%, scaledwidth=400]
...
image::configed_serverkonsole-terminal.png["{opsi-configed}: SSH-Terminal", pdfwidth=80%, scaledwidth=400]
...
image::configed_serverkonsole-defcommands.png["{opsi-configed}: Befehle definieren", pdfwidth=80%, scaledwidth=400]
...
image::configed_serverkonsole-exec.png["{opsi-configed}: Befehl ausführen - Parameterabfrage", pdfwidth=90%, scaledwidth=400]
