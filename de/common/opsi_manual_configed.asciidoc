...
image::opsi-configed-editlist1.png["{opsi-configed}: Property-Tabelle"]
...
image::opsi-configed-editlist2.png["{opsi-configed}: Listen-Editor, Auswahlliste"]
...
image::opsi-configed-editlist3.png["{opsi-configed}: Listeneditor, Editierfeld"]
...
image::opsi-configed-netbootproducts.png["{opsi-configed}: Tab Netboot-Produkte"]
...
image::opsi-configed-hardwareinformation.png["{opsi-configed}: Tab Hardware-Information"]
...
image::opsi-configed-hardwareinfo-treiberintegration.png["{opsi-configed}: Tab Hardware-Information - Treiberupload"]
...
image::opsi-configed-softwareinventory.png["{opsi-configed}: Tab Software-Inventur"]
...
image::opsi-configed-logfiles.png["{opsi-configed}: Tab Logdateien"]
...
image::opsi-configed-produkt-defaultproperties-jedit-verschiedene-werte.png["{opsi-configed}: Produkt-Defaultproperties: jEdit"]
...
image::opsi-configed-hostparameters.png["{opsi-configed}: Tab Hostparameter (als Serverkonfiguration)"]


.'{opsi-configed}': Tab Hostparameter (Kontextmenü eines Clienteintrags)
image::opsi-configed-hostparameter_setting.png["{opsi-configed}: Tab Hostparameter (Kontextmenü eines Clienteintrags)"]
...
image::opsi-configed-depotconfiguration.png["{opsi-configed}: Tab Depot-Konfiguration"]
...
image::configed_groupaction_localimage.png["{opsi-configed}: Gruppenaktionen (für opsi-local-image)"]
...
image::configed_package-actions.png["{opsi-configed}: Produktaktionen"]
...
image::configed_serverkonsole.png["{opsi-configed}: Server-Konsole"]
...
image::configed_serverkonsole-terminal.png["{opsi-configed}: SSH-Terminal"]
...
image::configed_serverkonsole-defcommands.png["{opsi-configed}: Befehle definieren"]
...
image::configed_serverkonsole-exec.png["{opsi-configed}: Befehl ausführen - Parameterabfrage"]
