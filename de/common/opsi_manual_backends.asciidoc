...
image::mysql-schema-inventory-software.png["Datenbankschema: Softwareinventarisierung"]
...
image::mysql-schema-configdata.png["Datenbankschema: Konfigurationsdaten"]
...
image::mysql-config-input-mask.png["opsi-setup --configure-mysql: Eingabemaske", scaledwidth=400]

.opsi-setup --configure-mysql: Ausgabe
image::mysql-config-output.png["opsi-setup --configure-mysql: Ausgabe", scaledwidth=400]
