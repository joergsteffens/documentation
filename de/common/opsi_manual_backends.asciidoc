...
image::mysql-schema-inventory-software.png["Datenbankschema: Softwareinventarisierung", pdfwidth=70%]
...
image::mysql-schema-configdata.png["Datenbankschema: Konfigurationsdaten", pdfwidth=80%]
...
image::mysql-config-input-mask.png["opsi-setup --configure-mysql: Eingabemaske", pdfwidth=70%, scaledwidth=400]

.opsi-setup --configure-mysql: Ausgabe
image::mysql-config-output.png["opsi-setup --configure-mysql: Ausgabe", pdfwidth=70%, scaledwidth=400]
