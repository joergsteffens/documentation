...
image::opsi-configed-mode-selection.png["{opsi-configed}: Leiste mit Schaltfläche Lizenzen (rechts)"]
...
image::licensemanagement-licensepools.png["Lizenzmanagement:Tab Lizenzpools"]
...
image::licensemanagement-createlicense.png["Lizenzmanagement:Tab 'Lizenz anlegen'"]
...
image::licensemanagement-editlicense.png["Lizenzmanagement:Tab 'Lizenzierungen bearbeiten'"]
...
image::licensemanagement-editlicense-copying-license-id.png["Lizenzmanagement:Kopieren der License-ID"]
...
image::licensemanagement-usages.png["Lizenzmanagement:Tab Lizenzenverwendung"]
...
image::licensemanagement-reconciliation.png["Lizenzmanagement:Tab Abgleich mit Inventarisierung]
...
image::licensemanagement-statistics.png["Lizenzmanagement:Tab Statistik"]
