...
image::opsi-configed-mode-selection.png["{opsi-configed}: Leiste mit Schaltfläche Lizenzen (rechts)", scaledwidth=50]
...
image::licensemanagement-licensepools.png["Lizenzmanagement:Tab Lizenzpools", pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-createlicense.png["Lizenzmanagement:Tab 'Lizenz anlegen'", pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-editlicense.png["Lizenzmanagement:Tab 'Lizenzierungen bearbeiten'", pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-editlicense-copying-license-id.png["Lizenzmanagement:Kopieren der License-ID", pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-usages.png["Lizenzmanagement:Tab Lizenzenverwendung", pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-reconciliation.png["Lizenzmanagement:Tab Abgleich mit Inventarisierung, pdfwidth=90%, scaledwidth=300]
...
image::licensemanagement-statistics.png["Lizenzmanagement:Tab Statistik", pdfwidth=90%, scaledwidth=300]
