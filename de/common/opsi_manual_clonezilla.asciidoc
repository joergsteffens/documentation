...
.Operation wählen.
image::clonezilla_select_mode.png[]
...
image::clonezilla_choosepart.png[]

.Das resultierende Kommando. Dieses kann auch im Produktproperty 'runcommand' verwendet werden
image::clonezilla_saveparts_command.png[]

.Fortschrittsanzeige
image::clonezilla_savepart_progress.png[]
...
image::clonezilla_choose_diskimage2restore.png[]

.Wahl der disk auf die das image restored werden soll
image::clonezilla_choose_restore_targetdisk.png[]

.Das resultierende Kommando. Dieses kann auch im Produktproperty 'runcommand' verwendet werden
image::clonezilla_restoredisk_command.png[]
...
image::clonezilla_restoredisk_askbeforeinst.png[]

.Fortschrittsanzeige
image::clonezilla_restoredisk_progress.png[]
...
image::clonezilla_choose_partimage2restore.png[]

.Wahl der partition auf die das image restored werden soll
image::clonezilla_choose_restore_targetpart.png[]

.Das resultierende Kommando. Dieses kann auch im Produktproperty 'runcommand' verwendet werden
image::clonezilla_restorepart_command.png[]

.Rückfrage vor dem Beginn des Überschreibens der disk. Kann durch entfernen der Option -c aus dem Kommando unterdrückt werden.
image::clonezilla_restorepart_askbeforeinst.png[]

.Fortschrittsanzeige
image::clonezilla_restorepart_progress.png[]
