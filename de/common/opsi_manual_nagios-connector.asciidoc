...
image::opsi-config-server.png["opsi config server", pdfwidth=50%, width=200]
...
image::central-config-server.png["opsi multi depot environment", pdfwidth=50%, width=200]
...
.Verteilte Checks
image::verteilte_checks_de.png["opsi verteilte checks", pdfwidth=90%, width=400]
