...
image::opsi-client-kiosk_tile_simple_de.png["opsi-client-kiosk: Hauptfenster mit Kacheln (Default Modus)"]
...
image::opsi-client-kiosk_tile_expert_de.png["opsi-client-kiosk: Hauptfenster mit Kacheln (Experten Modus)"]
...
image::opsi-client-kiosk_list_expert_de.png["opsi-client-kiosk: Hauptfenster mit Listen (Experten Modus)"]
...
////
image::opsi-client-kiosk_num.png["opsi-client-kiosk: Hauptfenster"]
...
image::opsi-client-kiosk2.png["opsi Client Kiosk: Aktionsbestätigung"]
