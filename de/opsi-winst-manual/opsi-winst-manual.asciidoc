...
* `%IPAddress%` : (Deprecated) Liefert eine IP-Adresse eines Interface dieses Rechners. Verwenden Sie besser die Funktion `GetMyIpByTarget()`. +
...
image::waitforprocess_scheme_std.png["waitforprocess_scheme_std", pdfwidth=50%]
