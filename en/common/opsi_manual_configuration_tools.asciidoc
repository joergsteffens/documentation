...
image::opsi-webinterface2.png["opsi config interface: Access to the web service via browser", pdfwidth=90%]
...
image::opsiconfd-info-hour.png["opsiconfd info: opsiconfd values from the last hour", pdfwidth=60%]

.opsiconfd info: opsiconfd values from the last day
image::opsiconfd-info-day.png["opsiconfd info: opsiconfd values from the last day", pdfwidth=60%]
