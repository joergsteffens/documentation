...
image::opsi-setup-product_sort_algorithm.png["Choose the sort algorithm: Part 1", pdfwidth=90%]

.Choose the sort algorithm: Part 2
image::opsi-setup-product_sort_algorithm2.png["Choose the sort algorithm: Part 2", pdfwidth=90%]
