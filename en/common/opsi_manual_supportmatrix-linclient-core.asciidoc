...
|SLES 15                       | image:supported.png[width=15]      |  | image:supported.png[width=15] | image:supported.png[width=15]
...
|SLES 11SP4                    | image:discontinued.png[width=15]    | sles11sp4 | image:supported.png[width=15] | image:develop.png[width=15]
|SLES 11SP3                    | image:discontinued.png[width=15] | sles11sp3 | image:discontinued.png[width=15] | image:unsupported.png[width=15]
|openSuse Leap 15.2            | image:develop.png[width=15]    | opensusel15-2 | image:supported.png[width=15] | image:supported.png[width=15]
...
|UCS 4.3                       | image:discontinued.png[width=15]    | | |
|UCS 4.2                       | image:discontinued.png[width=15] | | |
