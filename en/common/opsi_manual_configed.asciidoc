...
image::opsi-configed-login.png["opsi-configed: login mask", pdfwidth=90%]
...
image::configed-masterbuttons2.png["{opsi-configed}: Button bar", pdfwidth=50%]
...
image::opsi-configed-mode-depotselection.png["{opsi-configed}: depot selection", pdfwidth=30%, width=40%]
...
image::opsi-configed-clientselection-search.png["{opsi-configed}: Client search", pdfwidth=90%]
...
image::configed_toolbar_icons_sessions.png["{opsi-configed}: Button SessionInfo", pdfwidth=50%]
...
image::configed_clientselection2.png["{opsi-configed}: Saved Searches", pdfwidth=50%]
...
image::opsi-configed-failedactions-today_en.png["{opsi-configed}: Failed Actions - today", pdfwidth=90%]
...
image::opsi-configed-treeview.png["{opsi-configed}: Treeview with clients and groups", pdfwidth=60%]
...
image::opsi-configed-treeview-generate-group.png["{opsi-configed}: Using the context menu to create a new subgroup", pdfwidth=60%]
...
image::opsi-configed-clientinfos.png["{opsi-configed}: Erweiterte Spaltensicht für opsi-Clients", pdfwidth=60%]
...
image::opsi-configed-client-message-editing.png["{opsi-configed}:  opsi message edit mask", pdfwidth=50%]
...
image::opsi-configed-client-message-reading.png["{opsi-configed}:  opsi message display dialog", pdfwidth=50%]
...
image::opsi-configed-client-remotecontrol-choice.png["{opsi-configed}: Choice of Remote Control call", pdfwidth=50%]
...
image::opsi-configed-client-new.png["{opsi-configed}:  creating a client", pdfwidth=90%]
...
image::opsi-configed-client-change-depot.png["{opsi-configed}: change the depot of a client", pdfwidth=50%]
...
image::configed_productsearch.png["{opsi-configed}: Product search with context menu", pdfwidth=90%]
...
image::opsi-configed-editlist1.png["{opsi-configed}: property table with tooltip ", pdfwidth=90%]
...
image::opsi-configed-editlist2.png["{opsi-configed}:  list editor, selection list", pdfwidth=50%]
...
image::opsi-configed-editlist3.png["{opsi-configed}: list editor, edit field", pdfwidth=50%]
...
image::opsi-configed-hostparameter_setting.png["{opsi-configed}:  Tab Host parameters (context menü of a client entry)", pdfwidth=70%]
...
image::configed_serverkonsole.png["{opsi-configed}: Server Console", pdfwidth=90%]
...
image::configed_serverkonsole-terminal.png["{opsi-configed}: SSH-Terminal", pdfwidth=90%]
