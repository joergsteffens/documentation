...
image::opsiclientd-event-notifier.png["opsiclientd event notifier", pdfwidth=50%]

action notifier::
Shows state of the event processing

.opsiclientd action notifier
image::opsiclientd-action-notifier.png["opsiclientd action notifier", pdfwidth=50%]
...
image::opsiclientd-shutdown-notifier.png["opsiclientd shutdown notifier", pdfwidth=50%]
...
image::eventflowchsrt.png["simplified work flow of a 'standard event'", pdfwidth=90%]
...
image::opsi-systray-message.png["Message window of the opsi-systray program", pdfwidth=70%]

.Context menu (right mouse click) of the opsi-systray program
image::opsi-systray-menue.png["Context menu (right mouse click) of the opsi-systray program", pdfwidth=70%]
