...
image::opsi-client-kiosk_tile_simple_en.png["opsi-client-kiosk: Main window with tiles (Default Modus)", pdfwidth=90%]
...
image::opsi-client-kiosk_tile_expert_en.png["opsi-client-kiosk: Main window with tiles (Expert Mode)", pdfwidth=90%]
...
image::opsi-client-kiosk_list_expert_en.png["opsi-client-kiosk: Main window with lists (Expert Mode)", pdfwidth=90%]
...
image::opsi-client-kiosk_num.png["opsi-client-kiosk: Main Window", pdfwidth=90%]
...
image::opsi-client-kiosk2.png["opsi-client-kiosk: Confirm action", pdfwidth=70%]
