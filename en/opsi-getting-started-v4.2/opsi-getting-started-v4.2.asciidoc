...
.Input mask
image::1stboot-input-mask.jpg["Screenshot: 1stboot Input mask", pdfwidth=90%]
...
image::boot-cd-select.png["Screenshot: bootimage/boot-cd:  Choose how to create Client", pdfwidth=60%]
...
image::boot-cd-product.png["Screenshot: bootimage/boot-cd: netboot product list", pdfwidth=90%]
